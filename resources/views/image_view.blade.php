                ...
                <div class="content-wrapper container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Image View <small></small></h1>
                                <ol class="breadcrumb">
                                    <li><a href="#"><i class="fa fa-home"></i></a></li>
                                    <li class="active">Image View</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-striped table-bordered">
                      ...
                      <tr>
                        ...
                        <td><img width="100px" class="img-circle" src="{{ URL::asset('/adminpanel/images/'.$num->image) }}"></td>
                        <td>{{$num->link}}</td>
                        <td>
                          <a href="{{ route('edit', $num->id) }}" class="btn btn-primary">Edit</a>
                        </td>
                        <td>
                            <form method="POST" action="">
                                ...
                                <div class="form-group">
                                  <a href="{{ route('image_delete', [$num->id]) }}" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                                </div>
                            </form>
                        </td>
                      </tr>
