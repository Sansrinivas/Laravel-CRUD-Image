<nav class="navbar-aside navbar-static-side " id="menu">
    <div class="sidebar-collapse">
        ...
        <ul class="nav" id="side-menu">
              ...
              <li><a href="{{ config('app.url') }}/image_view">Data View</a></li>
                <li><a href="{{ config('app.url') }}/slider">Upload</a></li>

            <!-- <li class="active">
                <a href="{{ config('app.url') }}/home"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboard </span><span class="label label-rouded pull-right p1-bg note-icon">1</span></a>
            </li>
            <li>
            ...
            <li>
                <a href="#"><i class="fa fa-envelope"></i> <span class="nav-label">Slider </span><span class="fa fa-plus"></span></a>
                <ul class="nav nav-second-level collapse">
                    <li><a href="{{ config('app.url') }}/slider">Image Upload</a></li>
                    <li><a href="{{ config('app.url') }}/image_view">Image View</a></li>
                </ul>
            </li>
            <li>
